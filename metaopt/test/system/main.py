...
from metaopt.test.util.function.integer.fast.explicit.f import f as f_max_fast
from metaopt.test.util.function.integer.fast.explicit.g import f as f_min_fast
from metaopt.test.util.function.integer.fast. \
    implicit import FUNCTIONS_FAST_IMPLICIT
from metaopt.test.util.function.integer.slow.explicit.f import f as f_max_slow
from metaopt.test.util.function.integer.slow.explicit.g import f as f_min_slow
